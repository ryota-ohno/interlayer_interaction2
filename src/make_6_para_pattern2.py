...
def make_gjf_xyz(auto_dir,monomer_name,params_dict,isInterlayer):
    ...
    if a_ > b_:
        ...
        monomer_array_p1 = get_monomer_xyzR(monomer_name,a_,0,2*R4-R3,0,0,A3, phi1)##p2がa方向
        monomer_array_ip1 = get_monomer_xyzR(monomer_name,c[0]+a_,c[1],c[2]+2*R4-R3,0,0,A3, phi1)
        monomer_array_ip2 = get_monomer_xyzR(monomer_name,c[0]-a_,c[1],c[2]-(2*R4-R3),0,0,A3, phi1)
    ...
    if a_ > b_:
        monomer_array_ip3 = get_monomer_xyzR(monomer_name,c[0],c[1]+b_,c[2]+R3,0,0,-A3, phi1)
        monomer_array_ip4 = get_monomer_xyzR(monomer_name,c[0],c[1]-b_,c[2]-R3,0,0,-A3, phi1)
    else:
